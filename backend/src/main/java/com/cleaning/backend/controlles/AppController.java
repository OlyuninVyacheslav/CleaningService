...
public class AppController {
    ...
    public AppController(AppService appService, UserAuthenticationProvider authenticationProvider,
                         ClientRepository clientRepository, TypeListRepository typeListRepository, BasisListRepository basisListRepository) {
    ...
    @GetMapping
    public ResponseEntity<List<App>> getAllApps(@RequestHeader("Authorization") String token) {
        try {
